...
void loop() {
  ...
  //read all channels
  analog_read[0]= analogRead(A0);
  analog_read[1]= analogRead(A1);
  analog_read[2]= analogRead(A2);
  analog_read[3]= analogRead(A3);
  analog_read[4]= analogRead(A4);
  analog_read[5]= analogRead(A5);
  analog_read[6]= analogRead(A6);
  analog_read[7]= analogRead(A7);
